...
public class Transactions {
     ...
     */
    public Transactions(int id, double account_id, String transaction_type, double category_id, double payee_id, double transaction_date, String notes, double creation_date, double last_update_date, double amount, double recurring_id, double to_account_id, String is_transfer_flag) {
        this.setId(id);
